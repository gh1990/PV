...
' Este setat de workbook-ul PV.xlsm la deschidere, prin Application.Run "InitHost", ThisWorkbook.
...
' Returnează workbook-ul gazdă, cu fallback pe ThisWorkbook (pentru scenarii de test).
